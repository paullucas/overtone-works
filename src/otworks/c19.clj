...
(boot)
(get-mono-samples "~/Producing/november4th-2016/chops/smpls/" (mapv #(str "s" %) (range 3 6)))
...
(do (ctl x :rate 8)
    (ctl z :rate 0.6))
(do (ctl x :rate 2 :cpos 0.35)
    (ctl z :rate 0.7 :cpos 0.3))
(do (ctl x :rate 0.7 :cpos 0.15)
    (ctl z :cpos 0.45))
(ctl z :rate 0.73)
(ctl z :rate 0.72 :cpos 0.5)
(do (ctl x :rate 2 :cpos 0.75)
    (ctl y :rate 22 :amp 2))
(do (ctl x :rate 8)
    (ctl y :rate 28))
(ctl y :rate 32)
