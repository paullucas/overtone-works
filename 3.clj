...
(definst wrpr [buf 0 pointer 0 amp 1 att 10 mix 1 room 1 damp 1 gate 1 freq-scale 1 window-size 0.1 envbufnum -1 overlaps 8 interp 1]
...
(definst wrpf [buf 0 pointer 0 amp 1 att 10 lff 2000 gate 1 freq-scale 1 window-size 0.1 envbufnum -1 overlaps 8 interp 1]
...
(wrpr one :pointer 0.83 :freq-scale 0.4 :window-size 10.0 :overlaps 1 :interp 4 :amp 1.5 :attack 15 :release 40)  ;;42
(wrpf three :lff 1000 :pointer 0.23 :freq-scale 0.8 :window-size 16.0 :overlaps 1 :interp 4 :amp 1.8 :attack 15 :release 40)   ;;43
(wrpr two :pointer 0.27 :freq-scale 0.55 :window-size 9.0 :overlaps 1 :interp 4 :amp 0.7 :attack 15 :release 40) ;;44
(wrpf four :lff 2000 :pointer 0.27 :freq-scale 2.3 :window-size 12.0 :overlaps 1 :interp 4 :amp 1.9 :attack 15 :release 40)  ;;44
...
(wrpr two :pointer 0.67 :freq-scale 9.55 :window-size 3.0 :overlaps 1 :interp 4 :amp 0.7 :attack 5 :release 20) ;;46
